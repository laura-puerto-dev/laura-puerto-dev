...
🎯 I build production-grade backend and AI systems in Python. 18 years in enterprise engineering taught me one thing: design for failure first.

🎓 Deepening my AI engineering practice with thePower Tech School's **Master in AI Engineering** — RAG, agentic systems, deployment, observability.
...
18 years designing and maintaining enterprise ERP systems (Microsoft Dynamics AX) — reconciling data across systems, validating multi-level business workflows, automating reporting. Certified in Unity Game Development. This background is why I default to asking "what happens when this fails" before "what happens when this works."
